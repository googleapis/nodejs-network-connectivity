...
describe('v1alpha1.HubServiceClient', () => {
    ...
    describe('getHub', () => {
        it('invokes getHub without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1alpha1.Hub());
    ...
    describe('getSpoke', () => {
        it('invokes getSpoke without error', async () => {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1alpha1.Spoke());
