...
describe('v1.HubServiceClient', () => {
    ...
    describe('getHub', () => {
        it('invokes getHub without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.GetHubRequest());
            request.name = '';
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.Hub());
            client.innerApiCalls.getHub = stubSimpleCall(expectedResponse);
            const [response] = await client.getHub(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getHub as SinonStub)
        ...
        it('invokes getHub without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getHub(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1.IHub|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('getSpoke', () => {
        it('invokes getSpoke without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.GetSpokeRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.Spoke());
            client.innerApiCalls.getSpoke = stubSimpleCall(expectedResponse);
            const [response] = await client.getSpoke(request);
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.getSpoke as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes getSpoke without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.getSpoke(
                    request,
                    (err?: Error|null, result?: protos.google.cloud.networkconnectivity.v1.ISpoke|null) => {
                        if (err) {
                            reject(err);
                        } else {
                            resolve(result);
    ...
    describe('createHub', () => {
        it('invokes createHub without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.CreateHubRequest());
            request.parent = '';
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createHub as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createHub without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createHub(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1.IHub, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1.IHub, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createHub as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('updateHub', () => {
        it('invokes updateHub without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.UpdateHubRequest());
            request.hub = {};
            request.hub.name = '';
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateHub as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deleteHub', () => {
        it('invokes deleteHub without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.DeleteHubRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteHub as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('createSpoke', () => {
        it('invokes createSpoke without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.CreateSpokeRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createSpoke as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes createSpoke without error using callback', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                 client.createSpoke(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1.ISpoke, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>|null
                    ) => {
                        if (err) {
                            reject(err);
                        } else {
            ...
            const operation = await promise as LROperation<protos.google.cloud.networkconnectivity.v1.ISpoke, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>;
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.createSpoke as SinonStub)
                .getCall(0).calledWith(request, expectedOptions /*, callback defined above */));
    ...
    describe('updateSpoke', () => {
        it('invokes updateSpoke without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.UpdateSpokeRequest());
            request.spoke = {};
            request.spoke.name = '';
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.updateSpoke as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('deactivateSpoke', () => {
        it('invokes deactivateSpoke without error', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.DeactivateSpokeRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.deactivateSpoke = stubLongRunningCall(expectedResponse);
            const [operation] = await client.deactivateSpoke(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deactivateSpoke as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes deactivateSpoke without error using callback', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.deactivateSpoke = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
        ...
        it('invokes deactivateSpoke with call error', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deactivateSpoke = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.deactivateSpoke(request), expectedError);
            assert((client.innerApiCalls.deactivateSpoke as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes deactivateSpoke with LRO error', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.deactivateSpoke = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.deactivateSpoke(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.deactivateSpoke as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkDeactivateSpokeProgress without error', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkDeactivateSpokeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkDeactivateSpokeProgress with error', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkDeactivateSpokeProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });

    describe('activateSpoke', () => {
        it('invokes activateSpoke without error', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ActivateSpokeRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.activateSpoke = stubLongRunningCall(expectedResponse);
            const [operation] = await client.activateSpoke(request);
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.activateSpoke as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes activateSpoke without error using callback', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedResponse = generateSampleMessage(new protos.google.longrunning.Operation());
            client.innerApiCalls.activateSpoke = stubLongRunningCallWithCallback(expectedResponse);
            const promise = new Promise((resolve, reject) => {
                 client.activateSpoke(
                    request,
                    (err?: Error|null,
                     result?: LROperation<protos.google.cloud.networkconnectivity.v1.ISpoke, protos.google.cloud.networkconnectivity.v1.IOperationMetadata>|null
                    ) => {
        ...
        it('invokes activateSpoke with call error', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.activateSpoke = stubLongRunningCall(undefined, expectedError);
            await assert.rejects(client.activateSpoke(request), expectedError);
            assert((client.innerApiCalls.activateSpoke as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });

        it('invokes activateSpoke with LRO error', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            const expectedError = new Error('expected');
            client.innerApiCalls.activateSpoke = stubLongRunningCall(undefined, undefined, expectedError);
            const [operation] = await client.activateSpoke(request);
            await assert.rejects(operation.promise(), expectedError);
            assert((client.innerApiCalls.activateSpoke as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        ...
        it('invokes checkActivateSpokeProgress without error', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.operationsClient.getOperation = stubSimpleCall(expectedResponse);
            const decodedOperation = await client.checkActivateSpokeProgress(expectedResponse.name);
            assert.deepStrictEqual(decodedOperation.name, expectedResponse.name);
            assert(decodedOperation.metadata);
            assert((client.operationsClient.getOperation as SinonStub).getCall(0));
        });

        it('invokes checkActivateSpokeProgress with error', async () => {
            const client = new hubserviceModule.v1.HubServiceClient({
              credentials: {client_email: 'bogus', private_key: 'bogus'},
              projectId: 'bogus',
        });
            ...
            client.operationsClient.getOperation = stubSimpleCall(undefined, expectedError);
            await assert.rejects(client.checkActivateSpokeProgress(''), expectedError);
            assert((client.operationsClient.getOperation as SinonStub)
                .getCall(0));
        });
    });
    ...
    describe('deleteSpoke', () => {
        it('invokes deleteSpoke without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.DeleteSpokeRequest());
            request.name = '';
            const expectedHeaderRequestParams = "name=";
            const expectedOptions = {
                otherArgs: {
            ...
            const [response] = await operation.promise();
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.deleteSpoke as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
    ...
    describe('listHubs', () => {
        it('invokes listHubs without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ListHubsRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.Hub()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.Hub()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.Hub()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listHubs as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listHubsStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1.Hub) => {
    ...
    describe('listSpokes', () => {
        it('invokes listSpokes without error', async () => {
            ...
            client.initialize();
            const request = generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.ListSpokesRequest());
            request.parent = '';
            const expectedHeaderRequestParams = "parent=";
            const expectedOptions = {
                otherArgs: {
            ...
            const expectedResponse = [
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.Spoke()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.Spoke()),
              generateSampleMessage(new protos.google.cloud.networkconnectivity.v1.Spoke()),
            ];
            ...
            assert.deepStrictEqual(response, expectedResponse);
            assert((client.innerApiCalls.listSpokes as SinonStub)
                .getCall(0).calledWith(request, expectedOptions, undefined));
        });
        ...
        it('invokes listSpokesStream without error', async () => {
            ...
            const promise = new Promise((resolve, reject) => {
                ...
                stream.on('data', (response: protos.google.cloud.networkconnectivity.v1.Spoke) => {
                    responses.push(response);
                });
                stream.on('end', () => {
                    resolve(responses);
