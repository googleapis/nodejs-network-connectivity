...
function main(parent) {
  // [START networkconnectivity_v1_generated_HubService_ListHubs_async]
  /**
  ...
  const {HubServiceClient} = require('@google-cloud/networkconnectivity').v1;
  ...
  listHubs();
  // [END networkconnectivity_v1_generated_HubService_ListHubs_async]
}
